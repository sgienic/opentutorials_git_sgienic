...
public class DateUtil {
	...
	/**
	* <p>현재 날짜와 시각을yyyyMMdd 형태로 변환 후 return.
	 *
	* @param null
	* @return yyyyMMdd
	* 
	...
	*/
	...
	/**
	* <p>현재 날짜와 시각을yyyyMMddhhmmss 형태로 변환 후 return.
	* 
	* @param null
	...
	*/
	...
	//
	public static String getCurrentTime00() {
	Date today = new Date();
	Locale currentLocale = new Locale("KOREAN", "KOREA");
